...
for.cond.7:                                       ; preds = %for.inc.28, %for.end
  ...
  %cmp8 = icmp slt i32 %j.1, 2048
  br i1 %cmp8, label %for.body.10, label %for.end.30

for.body.10:                                      ; preds = %for.cond.7
  %conv11 = sitofp i32 %i.0 to float
  %conv12 = sitofp i32 %j.1 to float
...
for.cond.14:                                      ; preds = %for.inc.47, %for.body.13
  ...
  %cmp15 = icmp slt i32 %k.0, 2048
  br i1 %cmp15, label %for.body.16, label %for.end.49

for.body.16:                                      ; preds = %for.cond.14
  %mul17 = mul nsw i32 %i.1, 2048
  ...
  %mul32 = mul nsw i32 %i.1, 2048
  %add33 = add nsw i32 %mul32, %k.0
  %idxprom34 = sext i32 %add33 to i64
  %arrayidx35 = getelementptr inbounds float, float* %B, i64 %idxprom34
  %tmp4 = load float, float* %arrayidx35, align 4
  %mul36 = fmul float 1.243500e+04, %tmp4
  %mul37 = mul nsw i32 %j.1, 2048
  ...
  %mul41 = fmul float %mul36, %tmp5
  %mul42 = mul nsw i32 %i.1, 2048
  %add43 = add nsw i32 %mul42, %j.1
  %idxprom44 = sext i32 %add43 to i64
  %arrayidx45 = getelementptr inbounds float, float* %C, i64 %idxprom44
  %tmp6 = load float, float* %arrayidx45, align 4
  %add46 = fadd float %tmp6, %mul41
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx7 = getelementptr inbounds float, float* %C_Gpu, i64 %idxprom6
...
for.end.15:                                       ; preds = %for.cond
  %call16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str.1, i32 0, i32 0), double 1.000000e-01, i32 %fail.0)
  ret void
}
...
entry:
  ...
  %call4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %tmp4, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0))
  call void @init_arrays(float* %tmp, float* %tmp1, float* %tmp3)
  %call5 = call double @rtclock()
  call void @GPU__syr2k(float* %tmp, float* %tmp1, float* %tmp3)
  ...
  call void @syr2k(float* %tmp, float* %tmp1, float* %tmp2)
