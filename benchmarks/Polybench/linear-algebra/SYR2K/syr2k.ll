...
; Function Attrs: nounwind uwtable
define void @syr2k(i32 %ni, i32 %nj, float* %A, float* %B, float* %C) #0 {
entry:
  br label %for.cond
...
entry:
  ...
  %call3 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %tmp3, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0))
  call void @init_arrays(float* %tmp, float* %tmp1, float* %tmp2)
  %call4 = call double @rtclock()
  call void @syr2k(i32 2048, i32 2048, float* %tmp, float* %tmp1, float* %tmp2)
