...
for.body.11:                                      ; preds = %for.cond.8
  ...
  %add29 = add nsw i32 %j.0, 1
  %mul30 = mul nsw i32 %add29, %x
  ...
  %mul38 = mul nsw i32 %i.0, %mul37
  %sub39 = sub nsw i32 %j.0, 1
  %mul40 = mul nsw i32 %sub39, %x
  ...
  %mul59 = mul nsw i32 %j.0, %x
  %add60 = add nsw i32 %mul58, %mul59
  %sub61 = sub nsw i32 %k.0, 1
  ...
  %mul74 = fmul float 0x3FC99999A0000000, %tmp6
...
entry:
  ...
  call void @jacobi3d7pt(i32 10, i32 %add, i32 %add4, i32 %add5, float* %tmp, float* %tmp1)
