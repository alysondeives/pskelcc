...
; Function Attrs: nounwind uwtable
define void @jacobi3d25pt(i32 %tsteps, i32 %x, i32 %y, i32 %z, float* %A, float* %B) #0 {
entry:
  br label %for.cond
...
entry:
  ...
  call void @jacobi3d25pt(i32 10, i32 %add, i32 %add4, i32 %add5, float* %tmp, float* %tmp1)
