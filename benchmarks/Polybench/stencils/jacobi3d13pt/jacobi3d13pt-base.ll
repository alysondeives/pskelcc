...
for.body.11:                                      ; preds = %for.cond.8
  ...
  %44 = load float, float* %c2, align 4
  ...
  %sub59 = sub nsw i32 %57, 2
  %58 = load i32, i32* %x.addr, align 4
  %mul60 = mul nsw i32 %sub59, %58
  ...
  %80 = load float, float* %c4, align 4
  ...
  %mul89 = mul nsw i32 %84, %85
  %add90 = add nsw i32 %mul88, %mul89
  %86 = load i32, i32* %k, align 4
  %add91 = add nsw i32 %86, 2
  ...
  %89 = load float, float* %c5, align 4
  ...
  %mul99 = mul nsw i32 %93, %94
  %add100 = add nsw i32 %mul98, %mul99
  %95 = load i32, i32* %k, align 4
  %sub101 = sub nsw i32 %95, 2
  ...
  %98 = load float, float* %c4, align 4
  ...
  %107 = load float, float* %c5, align 4
  ...
  %116 = load float, float* %c6, align 4
  ...
  %add131 = add nsw i32 %add130, %122
  %idxprom132 = sext i32 %add131 to i64
  %123 = load float*, float** %A.addr, align 8
  %arrayidx133 = getelementptr inbounds float, float* %123, i64 %idxprom132
  %124 = load float, float* %arrayidx133, align 4
  %mul134 = fmul float %116, %124
  %add135 = fadd float %add126, %mul134
  %125 = load i32, i32* %i, align 4
  %126 = load i32, i32* %x.addr, align 4
  %127 = load i32, i32* %y.addr, align 4
  %mul136 = mul nsw i32 %126, %127
  %mul137 = mul nsw i32 %125, %mul136
  %128 = load i32, i32* %j, align 4
  %129 = load i32, i32* %x.addr, align 4
  %mul138 = mul nsw i32 %128, %129
  ...
  %arrayidx142 = getelementptr inbounds float, float* %131, i64 %idxprom141
...
for.cond.149:                                     ; preds = %for.inc.181, %for.end.148
  ...
  %sub150 = sub nsw i32 %136, 2
  %cmp151 = icmp slt i32 %135, %sub150
...
for.cond.153:                                     ; preds = %for.inc.178, %for.body.152
  ...
  %sub154 = sub nsw i32 %138, 2
  %cmp155 = icmp slt i32 %137, %sub154
...
for.cond.157:                                     ; preds = %for.inc.175, %for.body.156
  ...
  %sub158 = sub nsw i32 %140, 2
  %cmp159 = icmp slt i32 %139, %sub158
...
for.body.160:                                     ; preds = %for.cond.157
  ...
  %mul161 = mul nsw i32 %142, %143
  %mul162 = mul nsw i32 %141, %mul161
  %144 = load i32, i32* %j, align 4
  %145 = load i32, i32* %x.addr, align 4
  %mul163 = mul nsw i32 %144, %145
  %add164 = add nsw i32 %mul162, %mul163
  %146 = load i32, i32* %k, align 4
  %add165 = add nsw i32 %add164, %146
  %idxprom166 = sext i32 %add165 to i64
  %147 = load float*, float** %B.addr, align 8
  %arrayidx167 = getelementptr inbounds float, float* %147, i64 %idxprom166
  %148 = load float, float* %arrayidx167, align 4
  %149 = load i32, i32* %i, align 4
  %150 = load i32, i32* %x.addr, align 4
  %151 = load i32, i32* %y.addr, align 4
  %mul168 = mul nsw i32 %150, %151
  %mul169 = mul nsw i32 %149, %mul168
  %152 = load i32, i32* %j, align 4
  %153 = load i32, i32* %z.addr, align 4
  %mul170 = mul nsw i32 %152, %153
  %add171 = add nsw i32 %mul169, %mul170
  %154 = load i32, i32* %k, align 4
  %add172 = add nsw i32 %add171, %154
  %idxprom173 = sext i32 %add172 to i64
  %155 = load float*, float** %A.addr, align 8
  %arrayidx174 = getelementptr inbounds float, float* %155, i64 %idxprom173
  store float %148, float* %arrayidx174, align 4
  br label %for.inc.175

for.inc.175:                                      ; preds = %for.body.160
  %156 = load i32, i32* %k, align 4
  %inc176 = add nsw i32 %156, 1
...
for.inc.184:                                      ; preds = %for.end.183
  ...
  %inc185 = add nsw i32 %159, 1
  store i32 %inc185, i32* %t, align 4
  br label %for.cond
...
entry:
  ...
  call void @init(float* %3, i32 132, i32 132, i32 132, i32 2, i32 2, i32 2)
  ...
  call void @jacobi3d13pt(i32 %4, i32 %add, i32 %add4, i32 %add5, float* %8, float* %9)
